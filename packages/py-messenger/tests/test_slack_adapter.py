...
from py_messenger.message import Attachment, UniversalMessage
...
def _make_adapter(bot_user_id="U_BOT"):
    ...
    adapter_key = "py_messenger.adapters.slack"
    saved_adapter = sys.modules.pop(adapter_key, None)
    try:
        from py_messenger.adapters.slack import SlackAdapter
...
class TestStartStop:
    def test_start_creates_socket_handler(self):
        ...
        import py_messenger.adapters.slack as slack_mod
